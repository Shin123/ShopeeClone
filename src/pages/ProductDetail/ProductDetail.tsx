...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // Case 1 : get offsetX, offsetY simple when we handled bubble event in this case
    // const { offsetX, offsetY } = event.nativeEvent

    // Case 2: get offsetX, offsetY when we can't handle bubble event in this case
          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button
                  className='absolute left-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'
                  onClick={prev}
                >
                  <svg
                ...
                <button
                  className='absolute right-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'
                  onClick={next}
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='ml-4 rounded-sm bg-orange px-1 py-[2px] text-xs font-semibold uppercase text-white'>
                  {rateSale(product.price_before_discount, product.price)} {t('reduce')}
                </div>
              </div>
              <div className='mt-8 flex items-center'>
              ...
              <div className='mt-8 flex items-center '>
                ...
                <button
                 ...
                 bg-orange px-5 text-white shadow-sm outline-none hover:bg-orange/90'
                  onClick={buyNow}
                >
                  {t('buy now')}
                </button>
