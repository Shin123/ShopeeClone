          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button className='absolute left-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'>
                  <svg
                ...
                <button className='absolute right-0 top-1/2 z-10 h-9 -translate-y-1/2 bg-black/20 text-white'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
